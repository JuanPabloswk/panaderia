...
router.post('/', authenticate, authorize('admin', 'gerente'), upload.single('imagen'), crearCategoria);
router.put('/:id', authenticate, authorize('admin', 'gerente'), upload.single('imagen'), actualizarCategoria);
