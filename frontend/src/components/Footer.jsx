    ...
    <div>
      <section className="uk-section footer-main-section">
        <div className="uk-container">
          ...
          <div className='footer-grid uk-child-width-1-3@m uk-text-left' data-uk-grid>
            ...
            <div className='footer-column'>
              <h3 className="uk-text-bold">Síguenos</h3>
              <div className="uk-flex uk-flex-start uk-margin-top">
                <a href="https://facebook.com" target="_blank" rel="noreferrer"
                  className="uk-icon-button uk-margin-small-right social-icon" data-uk-icon="facebook"></a>
                <a href="https://twitter.com" target="_blank" rel="noreferrer"
                  className="uk-icon-button uk-margin-small-right social-icon" data-uk-icon="twitter"></a>
                <a href="https://instagram.com" target="_blank" rel="noreferrer"
                  className="uk-icon-button uk-margin-small-right social-icon" data-uk-icon="instagram"></a>
                <a href="https://youtube.com" target="_blank" rel="noreferrer"
                  className="uk-icon-button social-icon" data-uk-icon="youtube"></a>
              </div>
            </div>
